Vue.component('experiences', {
    template: `
        ...
        <div class="experience-box">
            <div class="row">
                <div class="job-pic-column" style="text-align: center;"> <img src="static/images/pythys.webp"></div>
            ...
            <div class="row">
                <div class="job-pic-column" style="text-align: center;"> <img src="static/images/starlabs.webp"></div>
                <div class="job-dis-column">
            ...
            <hr class="dark-mode-divider">
            <div class="row">
                <div class="job-pic-column" style="text-align: center;"> <img src="static/images/upwork1.webp" class="w-100"></div>
                <div class="job-dis-column">
