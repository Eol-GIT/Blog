Vue.component('e-commerce', {
    ...
    template: `
        ...
        <div class="jumbotron jumbotron-fluid my-0">
            ...
            <p class="lead">{{i18next.t("eCommerceIntro")}}</p>
            <p class="text-muted">{{i18next.t("linkToProjectText")}} <a href="https://www.piecex.com/source-code/Website-for-Online-Ordering-1972">{{i18next.t("here")}}</a></p>
            <p class="lead">{{i18next.t("technologiesUsedText", {projectName: "E-Commerce"})}}:</p>
            <ul class="list-group">
