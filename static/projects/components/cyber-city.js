    ...
    template: `
        ...
        <div class="carousel-inner container">
          <div class="carousel-item active">
            <img class="d-block w-100" src="../static/portfolio/images/projects/cyber-black.png" alt="First slide">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="../static/portfolio/images/projects/cyber-white.png" alt="Second slide">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="../static/portfolio/images/projects/cyber-ipad.png" alt="Third slide">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="../static/portfolio/images/projects/cyber-phone.png" alt="Third slide">
          </div>
        </div>
